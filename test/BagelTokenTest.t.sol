...
contract BagelTokenTest is Test {
    ...
    function test_ERC20_Transfer() public {
        ...
        assertEq(bagelToken.balanceOf(owner), initialBalance1 - TRANSFER_AMOUNT);
        assertEq(bagelToken.balanceOf(user1), initialBalance2 + TRANSFER_AMOUNT);
    }
     ...
     */
    function testFuzz_Transfer_VariousAmountsAndAddresses(address to, uint256 amount) public {
     ...
     */
    function testFuzz_Approve_VariousAmountsAndSpenders(address spender, uint256 amount) public {
